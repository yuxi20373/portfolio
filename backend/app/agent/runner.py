...
def run_turn(context_messages: list[dict], user_text: str, callbacks=None, run_id=None) -> tuple[str, dict]:
    agent = get_agent()
    ...
    usage = _aggregate_usage(all_messages, len(input_messages))
    return reply, usage
...
def _aggregate_usage(all_messages, input_message_count: int) -> dict:
    ...
    for m in new_messages:
        ...
        model_name = model_name or meta.get("model_name") or meta.get("model")
